...
export default function CinemaRoom() {
  ...
  return (
    <div
      ref={containerRef}
      className={`space-y-6 ${isFullscreen ? "bg-black text-white" : ""}`}>
      {/* Header del evento */}
      {!isFullscreen && (
      ...
      <div
        ...
        <Card
          className={`${
            showChat || showParticipants ? "lg:col-span-3" : "lg:col-span-1"
        ...
        {(showChat || showParticipants) && !isFullscreen && (
          <Card className='lg:col-span-1'>
            ...
            <CardContent className='p-0'>
              {showChat && <ChatPanel roomId={currentEvent.id} />}
              {showParticipants && (
                <ParticipantsPanel roomId={currentEvent.id} />
              )}
            </CardContent>
          </Card>
        )}
            ...
            <div className='grid md:grid-cols-2 gap-4'>
              <div>
                ...
                <p className='text-sm text-muted-foreground'>
                  Mesa redonda con los principales expertos en cardiología
                  intervencionista, donde se discutirán los últimos avances en
                  técnicas mínimamente invasivas y nuevos dispositivos para el
